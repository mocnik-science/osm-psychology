...
public class Cols {
    public static Set<Col> process(Col[] cols, QueryType queryType) {
        ...
        if (queryType == QueryType.CONTRIBUTION) {
            ...
            if (cs.contains(Col.TAG_INFORMATION)) cs.addAll(Set.of(Col.NUMBER_OF_TAGS_BEFORE, Col.TAGS_BEFORE, Col.NUMBER_OF_TAGS_AFTER, Col.TAGS_AFTER));
